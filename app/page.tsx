...
const galleryImages = [
  ...
  { src: `${BASE}/photos/05_Commercial_Space_Station_ISS_Predecessor.jpg`, alt: "Commercial Space Station", label: "Commercial Space Stations" },
  { src: `${BASE}/photos/05_Commercial_Space_Station_Starlab_Voyager_Airbus.jpg`, alt: "Starlab Space Station", label: "Commercial Space Stations" },
  { src: `${BASE}/photos/05_Commercial_Space_Station_Lunar_Base_Concept.jpg`, alt: "Lunar Base Concept", label: "Lunar Habitats" },
  { src: `${BASE}/photos/07_Space_Defense_Satellite_Laser_Network.jpeg`, alt: "Space Defense Satellite Laser Network", label: "Satellite Laser Networks" },
